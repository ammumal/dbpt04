...
<body>
    <h2><a href="index.html">메인</a> | 따릉이 월별 복잡도</h2>
    <h4> 조회하신 월에 <?=$gu_name?>는 과거 같은 월에 데이터를 보면</h4>
    <h3> 가장 복잡도가 심한 대여소는 <?=$rent_top?>입니다.</h3>
    <h4> 과거 해당 월에 이 대여소는 <?=$rent_count?>만큼 이용되었습니다. 따라서 <?=$rent_count2?>만큼 이용해서 복잡도가 가장 적은</h4>
    <h3> 다음 <?=$rent_name?> 대여소를 이용하시길 추천합니다.</h3>
</body>
